...
mysql_query("INSERT INTO admin_log (ip, time, action) VALUES('$ip', '$date', 'Logged In') ") 
...
<div id="container">
    ...
    <div id="main">
        <div id="header">
            <a href="#" class="logo"><img src="<?php print $row['game_logo'];?>" width="120" alt="" /> Army Ants RIMS Admin</a>
        ...
        <div id="middle">
            ...
            <div id="right-column">
                ...
                <div class="box">Welcome Admin! Here you can ban people and delete people and in general make everyone elses life miserable! Hi Siyuan! </div>
            </div>
        </div>
        <div id="footer">
